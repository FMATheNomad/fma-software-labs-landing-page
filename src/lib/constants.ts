export const products = [
  {
    ...
    status: "preview",
    category: "ai",
    cta: { text: "Preview ChatVein", url: "https://chatvein.up.railway.app" },
...
export const terminalLogs: Array<{
  ...
  { type: "success", message: "DebtWar — Social Chaos Economy MMO [MAINTENANCE]", delay: 3200 },
  { type: "success", message: "ChatVein — AI Conversation Analysis [PREVIEW]", delay: 4000 },
